...
import 'package:my_responsive_ui/screens/mobile_chat_screen.dart';
import '../info.dart';
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: ListTile(
                  ...
                  trailing:Text(info[index]['time'].toString(),style: const TextStyle(fontSize: 18,color: Colors.grey)),
                ),
              ),
            ),
           const  Divider(
